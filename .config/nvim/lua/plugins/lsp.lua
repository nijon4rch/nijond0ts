return {
	{
		...
		dependencies = {
			...
			"saadparwaiz1/cmp_luasnip",
			{
				...
				opts = {
					...
					notification = {
						view = {
							group_separator_hl = "fidgetGroupSep",
						},
						window = {
		...
		config = function()
			...
			-- (Every time a new file is opened that is associated with LSP)
			...
			vim.lsp.handlers["window/showMessage"] = function(_, result, ctx)
				...
				require("notify")(message, level, {
					title = client and ("LSP: " .. client.name) or "LSP",
				})
			end
		end,
	},
